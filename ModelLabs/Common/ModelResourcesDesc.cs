...
{	
	...
	public class ModelResourcesDesc
	{
		...
		//MENJANO, dodamo model codo-ve za sve konkretne klase
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.SEASON_REF);
            ...
            // isto za Season njegov SeasonDayTypeSchedules
            //DayType SeasonDayTypeSchedules
            // Switch ce imati SwitchSChedules
        }
