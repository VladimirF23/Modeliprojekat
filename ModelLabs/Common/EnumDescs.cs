...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			...
			property2enumType.Add(ModelCode.BASIC_IS_VALUE1_MULTIPLIER, typeof(UnitMultiplier));
            property2enumType.Add(ModelCode.BASIC_IS_VALUE1_UNIT, typeof(UnitSymbol));
            property2enumType.Add(ModelCode.BASIC_IS_VALUE2_MULTIPLIER, typeof(UnitMultiplier));
            property2enumType.Add(ModelCode.BASIC_IS_VALUE2_UNIT, typeof(UnitSymbol));
