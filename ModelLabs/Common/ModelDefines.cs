...
namespace FTN.Common
{
	...
	public enum ModelCode : long
	{
        ...
        SEASON      =                   0x1100000000001000,
        SEASON_END_DATE =               0x1100000000001018,
        SEASON_START_DATE =             0x1100000000001028,
        SEASON_REF        =             0x1100000000010319,

        DAYTYPE =                       0x1200000000002000,
        DAYTYPE_REF =                   0x1200000000020119,

        REGULAR_TIME_POINT =            0x1300000000003000,
        REGULAR_TIME_POINT_SQ_NUM =     0x1300000000003014,
        REGULAR_TIME_POINT_VALUE1 =     0x1300000000003025,
        REGULAR_TIME_POINT_VALUE2 =     0x1300000000003035,
        REGULAR_TIME_POINT_REF =        0x1300000000003049,
